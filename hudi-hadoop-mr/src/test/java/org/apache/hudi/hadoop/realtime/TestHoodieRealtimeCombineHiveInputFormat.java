...
import org.apache.hudi.hadoop.hive.HoodieRealtimeCombineHiveInputFormat;
...
public class TestHoodieRealtimeCombineHiveInputFormat extends HoodieCommonTestHarness {
  ...
  public void testHoodieRealtimeCombineHoodieInputFormat() throws Exception {
    ...
    File partitionDir = InputFormatTestUtil.prepareParquetDataset(basePath, schema, 3, numRecords, commitTime);
    ...
    tblDesc.setInputFileFormatClass(HoodieRealtimeCombineHiveInputFormat.class);
    ...
    HoodieRealtimeCombineHiveInputFormat combineHiveInputFormat = new HoodieRealtimeCombineHiveInputFormat();
